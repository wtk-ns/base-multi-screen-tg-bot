...
@Slf4j
public class SettingScreen extends BotScreen {

    public SettingScreen(Long screenId) {
        super(screenId);
    }
    ...
    public InlineKeyboardMarkup getScreenMarkup() {
        ...
        row.add(formButton("To screen 3", 1L, 3L, false));
        row.add(formButton("To screen 1", 2L, 1L, false));
